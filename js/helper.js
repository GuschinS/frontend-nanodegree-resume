...
var HTMLlocation = '<a href="https://goo.gl/maps/xj43k7n7yA72"><li class="flex-item"><span class="orange-text">location</span><span class="white-text">%data%</span></li>';
...
var HTMLworkEmployer = '<a class="work" href="#">%data%';
